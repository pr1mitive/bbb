...
// ========================================
console.log('========================================');
console.log('[customView_part2_debug] ファイルが読み込まれました');
console.log('[customView_part2_debug] window.addItemRow:', typeof window.addItemRow);
console.log('[customView_part2_debug] window.PO_CustomView:', window.PO_CustomView);

if (typeof window.addItemRow === 'function') {
  console.log('[customView_part2_debug] ✅ window.addItemRow は正常に定義されています');
} else {
  console.error('[customView_part2_debug] ❌ ERROR: window.addItemRow が定義されていません!');
  console.error('[customView_part2_debug] 読み込み順序を確認してください');
}

if (window.PO_CustomView && typeof window.PO_CustomView.addItemRow === 'function') {
  console.log('[customView_part2_debug] ✅ window.PO_CustomView.addItemRow も定義されています');
} else {
  console.warn('[customView_part2_debug] ⚠️  window.PO_CustomView.addItemRow が定義されていません');
}

console.log('[customView_part2_debug] 利用可能な関数:');
console.log('  - window.addItemRow:', typeof window.addItemRow);
console.log('  - window.openQuoteModal:', typeof window.openQuoteModal);
console.log('  - window.showProjectAllocationModal:', typeof window.showProjectAllocationModal);
console.log('========================================');
