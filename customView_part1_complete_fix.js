...
(function() {
  ...
  kintone.events.on('app.record.index.show', async function(event) {
    ...
    try {
      ...
      // 初期明細行を1行追加
      if (typeof window.addItemRow === 'function') { addItemRow(); } else { console.error('[PO] addItemRow not defined'); setTimeout(function() { if (typeof window.addItemRow === 'function') addItemRow(); }, 500); }
